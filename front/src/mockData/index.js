export const mockBaseCartData = [
    { id: 101, customerId: 1, productId: 1, quantity: 2, addedDate: "2023-10-27T10:00:00Z", updatedAt: "2023-10-27T10:05:00Z", product: { id: 1, categoryId: 2, name: "Laptop Pro 15", description: "High-performance laptop", price: 1299.99, stock: 50, images: [{id: 1, imageUrl: "https://placehold.co/600x400/EEE/31343C?text=Laptop", isPrimary: true}] } },
    { id: 102, customerId: 1, productId: 2, quantity: 1, addedDate: "2023-10-26T15:30:00Z", updatedAt: "2023-10-26T15:30:00Z", product: { id: 2, categoryId: 3, name: "Wireless Mouse", description: "Ergonomic mouse", price: 25.50, stock: 100, images: [{id: 2, imageUrl: "https://placehold.co/600x400/DDD/31343C?text=Mouse", isPrimary: true}] } },
    { id: 103, customerId: 1, productId: 3, quantity: 3, addedDate: "2023-10-27T11:00:00Z", updatedAt: "2023-10-27T11:00:00Z", product: { id: 3, categoryId: 4, name: "T-Shirt", description: "Cotton T-Shirt", price: 19.99, stock: 0, images: [{id: 3, imageUrl: "https://placehold.co/600x400/CCC/31343C?text=T-Shirt", isPrimary: true}] } }
];

export const mockBaseAddressData = [
...
export let mockProducts = [
    { id: 1, categoryId: 2, name: "Laptop Pro 15", description: "High-performance laptop", price: 1299.99, stock: 50, createdAt: "2023-10-05T09:00:00Z", updatedAt: "2023-10-05T09:00:00Z", isActive: true, images: [{id: 1, imageUrl: "https://placehold.co/600x400/EEE/31343C?text=Laptop", isPrimary: true}] },
    { id: 2, categoryId: 3, name: "Wireless Mouse", description: "Ergonomic mouse", price: 25.50, stock: 100, createdAt: "2023-10-05T09:05:00Z", updatedAt: "2023-10-05T09:05:00Z", isActive: true, images: [{id: 2, imageUrl: "https://placehold.co/600x400/DDD/31343C?text=Mouse", isPrimary: true}] },
    { id: 3, categoryId: 4, name: "T-Shirt", description: "Cotton T-Shirt", price: 19.99, stock: 200, createdAt: "2023-10-06T14:00:00Z", updatedAt: "2023-10-06T14:00:00Z", isActive: true, images: [{id: 3, imageUrl: "https://placehold.co/600x400/CCC/31343C?text=T-Shirt", isPrimary: true}] },
];

let currentMockCart = [...mockBaseCartData];
let currentMockAddresses = [...mockBaseAddressData];

let nextCategoryId = Math.max(0, ...mockCategories.map(c => c.id)) + 1;
let nextProductId = Math.max(0, ...mockProducts.map(p => p.id)) + 1;
let nextAddressId = Math.max(0, ...mockBaseAddressData.map(a => a.id)) + 1;
let nextCartItemId = Math.max(0, ...mockBaseCartData.map(i => i.id)) + 1;
...
export const simulateFetchCart = () => {
    ...
    return simulateApiCall(JSON.parse(JSON.stringify(currentMockCart)));
};
...
export const simulateFetchAddresses = () => {
    ...
    return simulateApiCall(JSON.parse(JSON.stringify(currentMockAddresses)));
};
...
export const simulateFetchCategories = () => {
    ...
    return simulateApiCall(JSON.parse(JSON.stringify(mockCategories)));
};
...
export const simulateCreateProduct = (productData) => {
    ...
    return simulateApiCall(null, 1000).then(() => {
        const newProduct = {
            ...
            updatedAt: new Date().toISOString(),
            isActive: true,
            images: [{ id: Date.now(), imageUrl: `https://placehold.co/100?text=New`, isPrimary: true }],
            reviews: [],
            cartItems: [],
            orderItems: []
        };
